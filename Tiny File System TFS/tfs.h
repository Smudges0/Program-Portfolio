...
#define MAGIC_NUM 0x5C3A // Magic number is just a code to identify a file as a specific type of file.  Check that superblock has this value in the right field.
#define MAX_INUM 1024		 // Max Inode blocks.  Use to scan i bitmap for blocks
#define MAX_DNUM 16384	 // Max Data blocks.  Use to scan d bitmap for blocks
#define VALID 1
#define INVALID 0
#define TYPE_FILE 1
#define TYPE_DIR 2
#define NUM_DIRECT_PTRS 16
#define NUM_INDIRECT_PTRS 8
